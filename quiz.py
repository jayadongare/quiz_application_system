...
# define question dictionary0
question = {
    "Who is the president of India?": ['Narendra Modi', 'Droupadi Murmu', 'Dr. Rajendra Pasad', 'Indira Gandhi'],
    "Who is the father of AI?": ['John McCarthy', 'Charles Babbage', 'Dennis Ritchie'],
    "What is the full form of NEP?": ['National Economic Policy', 'National Environmrnt Policy', 'National Education Policy']
}
# define answer list
ans = ['Droupadi Murmu', 'John McCarthy', 'National Education Policy']
